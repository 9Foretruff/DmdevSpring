...
//    @Pointcut("target(org.springframework.data.repository.Repository)")
     ...
     */
    @Pointcut("com.foretruff.spring.aop.CommonPointCuts.isControllerLayer() && @annotation(org.springframework.web.bind.annotation.GetMapping)")
    ...
    * - any param type
    ...
    @Pointcut("com.foretruff.spring.aop.CommonPointCuts.isControllerLayer() && args(org.springframework.ui.Model,..)")
    ...
    * - any param type
    ...
    @Pointcut("com.foretruff.spring.aop.CommonPointCuts.isControllerLayer() && @args(com.foretruff.spring.validation.UserInfo,..)")
